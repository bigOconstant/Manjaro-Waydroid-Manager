...
options[2]="||  Install microg                ||
       ...
       ||--------------------------------||"
options[3]="||  init x-gapps install w/-gapps ||
       ||--------------------------------||"
...
function MENU {
    ...
    echo -e "
\e[34m       || Manjaro Waydroid Manager v0.1.0||
       ||  ________Extra Options_______  || 
       || |       __          __       | ||
       || |       \ \        / /       | ||
       || |        \ \------/ /        | ||
       || | ____   /          \   ____ | ||
...
function MENU {
    ...
    echo -e "    \e[92m   ||Manjaro Waydroid Manager v0.1.0 ||
       ||  ____________________________  ||
       || |       __          __       | ||
       || |       \ \        / /       | ||
       || |        \ \------/ /        | ||
